...

{
    ...
    motor.setTorque(Vector3(0, 0.75, 0));
...
void MobileScene::draw(Renderer& renderer, Camera& camera)
{
    ...
    Vector3 b1 = spring1->getAnchorWorldA(&attachment1);           
    ...
    Vector3 b2 = spring2->getAnchorWorldA(&attachment2);
